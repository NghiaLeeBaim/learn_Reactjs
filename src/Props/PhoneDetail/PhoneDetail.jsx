...
export default class PhoneDetail extends Component {
        ...
        <div className="col-4" key={phone.maSP}>
          <div className="card">
            ...
            <div className="card-body">
              <h3>{phone.tenSP}</h3>
              <p>{phone.giaBan.toLocaleString()} đ</p>
              <button className="btn btn-success" onClick={()=>{
                this.viewDetail(phone)
              }}>view detail</button>
            </div>
          </div>
        </div>
  ...
  render() {
    const{maSP,tenSP,manHinh,heDieuHanh,cameraSau,cameraTruoc,ram,rom,giaBan,hinhAnh}=this.state.prodDetail;
    return (
